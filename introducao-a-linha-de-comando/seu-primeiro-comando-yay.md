...
Depois pressione a tecla `Enter`. Essa é nossa saída:
...
Como você pode ver, o terminal só apresentou o nome de usuário, no caso `gitpod`. Isso acontece pois o nome de usuário do nosso computador **virtual** é **gitpod**.
